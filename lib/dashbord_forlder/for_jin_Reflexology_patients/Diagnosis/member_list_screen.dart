...
import 'package:jin_reflex_new/api_service/model/dignosis_list_model.dart';
import 'package:jin_reflex_new/dashbord_forlder/for_jin_Reflexology_patients/Diagnosis/add_patient_screen.dart';
import 'package:jin_reflex_new/dashbord_forlder/for_jin_Reflexology_patients/Diagnosis/diagnosisListScreen_screen.dart';
  ...
  Future<void> fetchPatients({bool isInitial = false}) async {
    ...
    try {
      final response = await ApiService().postRequest(
        ...
        "?pid=${AppPreference().getInt(PreferencesKey.userId)}&page=$page&limit=$limit",
        {},
      );
              ...
              child:
                  isLoading
                      ...
                      : ListView.builder(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 14),
                        itemCount: filteredPatients.length + (hasMore ? 1 : 0),
