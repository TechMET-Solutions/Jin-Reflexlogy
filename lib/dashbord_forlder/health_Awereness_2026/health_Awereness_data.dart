...
class HealthCampaignData extends StatefulWidget {
  const HealthCampaignData({super.key});
...
class _HealthCampaignDataState extends State<HealthCampaignData> {
  ...
  void initState() {
    super.initState();
    campaignFuture = HealthCampaignApi().fetchCampaign();
  }
...
class HealthCampaignApi {
  ...
  Future<HealthCampaign> fetchCampaign() async {
    final response = await _dio.get(
      'https://admin.jinreflexology.in/api/health-campaigns/1',
    );
